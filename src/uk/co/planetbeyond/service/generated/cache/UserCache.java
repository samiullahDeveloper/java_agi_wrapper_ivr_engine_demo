...
public final class UserCache 
{
	...
	/**
	 * Maximum number of UserBean objects that may be in the cache.
	 */
	private int maxCacheSize = 80;

	/**
	 * The number of UserBean objects currently in the cache.
	 */
	 ...
	 * objects that refer to the actual UserBean.
	 */
	...
	*/
	...
	/**
	 * A UserBean object is passed to this method for addition to the cache.
	 */
	public void addUser(UserBean bean) 
	{
		synchronized(updateLock)
		{ 
			String id = bean.getMsisdn();
			if (null == cache.get(id)) 
			{
				...
				else 
				{
					...
					if (maxCacheSize < currentCacheSize) 
					{
						...
						cache.remove(newLink.bean.getMsisdn());
						lru.next = null;
					} 
					else 
					{
	...
	/**
	 * Return the UserBean associated with the given key.
	 */
	public UserBean fetchUser(String id) 
	{
		...
		if (null == foundLink) 
		{
			...
			try 
			{
				bean = UserManagerImpl.getInstance().loadByPrimaryKey(id);
			} 
	...
	/**
	 * Updates UserBean object in the cache.
	 */
	...
	/**
	 * Returns true if UserBean object is in the cache. FALSE otherwise
	 */
	public boolean isUserInCache(UserBean bean) 
	{
		String id = bean.getMsisdn();
